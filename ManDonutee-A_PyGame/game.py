'''
=-= ManDonutee, A PyGame game =-=
=-=- Composer: Brandon Rimes -=-=
=-=-=-=-=- 15 Feb 2021 -=-=-=-=-=
'''

'''
You are the Donut, avoid the Manatees.
Earn points for shooting Manatees.
Lose lives for getting caught by a Manatee.
Lives/Score reset automatically.
Use 'Q W E A S D Z C' to shoot, 'SPACE' for mines.
Move with mouse or 'LEFT UP RIGHT DOWN' keys.
Adjust setting below.
Run 'game.py'.
Enjoy!
'''
...
Z = 50              # --------------------------- adjust character size
walls_on = False    # 'True' 'False' ------------ toggle walls
movement = 'mouse'  # 'mouse' 'keys' ------------ keys = 'LEFT UP RIGHT DOWN' 
hole_mode = 'norm'  # 'norm' 'infinite' 'chain' - toggle projectile styles
enemy_delay = 100   # --------------------------- adjust enemy spawn rate
...
# enemy collides with player --------------------------------------------- #
            if player.colliderect(enemy):
                enemies = []
                life -= 1
# projectile behaviors / collision with enemy ----------------------------- #
